            ...
            <?php if ( hu_is_checked( 'credit' ) || hu_is_customizing() ) : ?>
              ...
              <?php ob_start(); ?>
                  <div id="credit" style="<?php echo ! hu_is_checked( 'credit' ) ? 'display:none' : ''; ?>">
                    <p><?php _e('Một trang blog của Webviban.com','Webviban.com'); ?>&nbsp;<a   class="" title="<?php _e( 'Một trang blog của Webviban.com', 'webviban.com' ) ?>" href="<?php echo esc_url( __( 'https://webviban.com/', 'Webviban.com' ) ); ?>" target="_blank"></a> - <?php _e('Thiết kế bởi Phạm Khương ',''); ?>&nbsp;<a href="<?php echo $hu_theme -> get(''); ?>" title="<?php _e('',''); ?>"><?php _e('',''); ?></a></p>
                  </div><!--/#credit-->
              <?php
